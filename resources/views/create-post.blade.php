...
<form action="{{ url('/blog/store') }}" class="form-group" method="POST">
	...
	<textarea name="cuerpo" class="form-control" id="cuerpo" cols="50" rows="15" onkeyup="liveContent(this.value)"></textarea><br>
